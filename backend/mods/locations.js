...
const locations = {
  ...
  boothillsaloon: new Location({ name: 'Boothill Saloon', city: 'Amersfoort' }),
  ...
  dewalrus: new Location({ name: 'De Walrus', city: 'Groningen' }),
  ...
  hetentrepot: new Location({ name: 'Entrepot', city: 'Brugge' }),
  ...
  hetklooster: new Location({ name: 'Het Klooster', city: 'Waalre' }),
  ...
  jckompleks: new Location({ name: 'JC Kompleks', city: 'Heerhugowaard' }),
  ...
  k77: new Location({ name: 'K77', city: 'Woerden' }),
  ...
  manifesto: new Location({ name: 'Manifesto', city: 'Hoorn' }),
  ...
  muziekcafehelmond: new Location({ name: 'Muziek café Helmond', city: 'Helmond' }),
  ...
  resistor: new Location({ name: 'Resistor', city: 'Leiden' }),
  ...
  vrankrijk: new Location({ name: 'Vrankrijk', city: 'Amsterdam' }),
