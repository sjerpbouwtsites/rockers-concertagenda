...
const locations = {
  ...
  drucultuurfabriek: new Location({ name: 'Dru Cultuurfabriek', city: 'Ulft' }),
  ...
  fortressjosefoz: new Location({ name: 'Fortress Josefoz', city: 'Jaromer' }),
  ...
  graspopmetalmeeting: new Location({ name: 'Graspop Metal Meeting', city: 'Oss' }),
  ...
  parknieuwekoers: new Location({ name: 'Park de nieuwe koers', city: 'Oostende' }),
  paterskerk: new Location({ name: 'Paterskerk', city: 'Eindhoven' }),
  patronaat: new Location({ name: 'Patronaat', city: 'Haarlem' }),
  paleissoestdijkbaarn: new Location({ name: 'Paleis Soestdijk', city: 'Baarn' }),
