    ...
    let rawEvents = await page.evaluate(
        ...
        ({ workerData, unavailabiltyTerms }) =>
            Array.from(
                ...
                .map((eventEl) => {
                    const title =
                        eventEl.querySelector('h3[class*="title"]')
                            ?.textContent ?? "";
                    const res = {
                    ...
                    let shortTitle =
                        eventEl.querySelector('[class*="subtitle"]')
                            ?.textContent ?? "";
                    ...
                    res.soldOut =
                        !!eventEl
                            .querySelector(
                                "[class*='styles_event-compact__text']"
                            )
