...
async function metalFanDoURL(page, url, qwm) {
  ...
  const rename = {
    ...
    desselbelgimetoagunsnroses: "graspopmetalmeeting",
    desselbelgimetoaslipknot: "graspopmetalmeeting",
    dessel: "graspopmetalmeeting",
    ...
    leeuwardenmetexodus: "intothegrave",
