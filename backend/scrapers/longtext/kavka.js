...
export default async function longTextSocialsIframes(page, event) {
    ...
    const selectors = {
        ...standaardSelectorConfig,
        textBody: ".content-wrapper .desktop .entry-content",
        mediaEls: [".desktop .epyt-video-wrapper iframe"].join(", "),
        removeEmptyHTMLFrom: ".content-wrapper .desktop .entry-content",
