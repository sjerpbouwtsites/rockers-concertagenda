...
export default async function longTextSocialsIframes(page, event) {
    ...
    const selectors = {
        ...standaardSelectorConfig,
        textBody: ".event-content-wrapper",
        mediaEls: [".event-content-wrapper iframe"].join(", "),
        removeEmptyHTMLFrom: ".event-content-wrapper"
    };
...
//             // tekst.
//             const d = document.querySelectorAll("[data-text]");
//             res.textForHTML =
//                 Array.from(d)
//                     .map((el) => el.innerHTML)
//                     .join("") +
