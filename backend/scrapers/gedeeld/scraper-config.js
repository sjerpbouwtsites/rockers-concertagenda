...
export default class ScraperConfig {
  static baseConfig = {
    ...
    app: {
      ...
      mainPage: {
        ...
        asyncCheckFuncs: [],
        skipEventRegexes: [], // welke sws nooit gepakt zullen worden.
      },
      singlePage: {
        // get page info
  ...
  constructor(obj) {
    ...
    this._s.app.harvest = {
      ...
      dividerRex: obj?.app?.harvest?.dividerRex ?? bc.app.harvest.dividerRex,
      possiblePrefix:
        obj?.app?.harvest?.possiblePrefix ?? bc.app.harvest.possiblePrefix,
    ...
    this._s.app.mainPage = {
      ...
      skipEventRegexes:
        obj?.app?.mainPage?.skipEventRegexes ??
        bc.app.mainPage.skipEventRegexes,
    };
